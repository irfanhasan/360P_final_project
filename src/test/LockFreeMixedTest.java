...
public class LockFreeMixedTest {
    ...
    public static void main(String[] args) {	
    	...
    	LockFreeMixedTest test = new LockFreeMixedTest(numOperations, threads, maxValue);
        System.out.println("=======================");
    ...
    public LockFreeMixedTest(int size, int threads, int maxValue) {
